# VICTECH since scipy.misc.imread/imresize is removed, we should make it compatible
# from https://raw.githubusercontent.com/scipy/scipy/v1.0.0/scipy/misc/pilutil.py
