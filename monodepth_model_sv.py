...
class MonodepthModel(object):
    ...
    def __init__(self, mode, left, right, left_feature, right_feature, left_disp, right_disp):
        self.mode = mode
        self.left = left
        self.right = right
...
class Model_stereosv(object):
    def __init__(self, imageL=None, imageR=None, dispL=None, dispR=None, scope=None):
        with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
            left_feature = feature_pyramid_disp(imageL, reuse=None)
...
class Model_eval_stereosv(object):
    def __init__(self, scope=None):
        with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
            ...
            feature_L = feature_pyramid_disp(input_L, reuse=None)
